...
def main():
    ...
    tests = [
        ...
        ("Day 12: Physics Validation (Structure)", tests_dir / "test_physics_validation_simple.py"),
        ("Day 13: Export Results (Structure)", tests_dir / "test_export_results_simple.py"),
